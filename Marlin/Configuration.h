...
//    You must specify the X & Y coordinates of all 3 points
  ...
  // Note: this feature occupies 10'206 byte
    ...
    #define RIGHT_PROBE_BED_POSITION 60
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,400}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {200, 200, 2, 35}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {2000,2000,20,2000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
